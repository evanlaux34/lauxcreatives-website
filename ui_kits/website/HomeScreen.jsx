    ...
    <div>
      ...
      <section style={{
        ...
        <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: isMobile ? 'flex-end' : 'center', textAlign: 'center', padding: isMobile ? '0 24px 74px' : '0 40px' }}>
          <img src="../../assets/logos/mark-circle-paper.png" alt="Laux Creatives" style={{ height: isMobile ? '46px' : '84px', width: 'auto', marginBottom: isMobile ? '10px' : '20px', filter: 'drop-shadow(0 2px 14px rgba(30,26,16,0.45))', transform: isMobile ? 'none' : 'translate(0px, -130px)', boxShadow: '0px 4px 12px 0px rgba(0, 0, 0, 0.15)' }} />
